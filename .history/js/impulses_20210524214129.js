...
import impulses_pro from './impulse_pro_files';
...
const appendElement = (idToSelect, files, idToAppend) => {
...
appendElement('#template1', impulses, '#impulse-responses');
appendElement('#template2', impulses_pro, '#impulse-responses-pro');
